...
<div class="body_cont_float2" style="height: 100vh;">
    <ul>
        <li style="width:100%; background:#f7f7f7; padding:50px 80px 50px 80px; min-height: 100vh;">
                ...
                <table class="t_table" cellpadding="0" cellspacing="0" border="0" width="100%">
                    ...
                    <tbody>
                        <?php if (!empty($List)) { ?>
                            ...
                            ?>
                                <tr>
                                    <td style="width:50px;" class="cen"><?php echo $num; ?></td>
                                    <td><?php echo $row->col1; ?></td>
                                    <td class="mlink add_act"><?php echo $row->col2; ?></td>
...
<script type="text/javascript">
    ...
    $(".add_act").on("click", function() {
        ...
        $.ajax({
            url: "<?php echo base_url('Tablet/ajax_prod_form') ?>",
            type: "POST",
            dataType: "HTML",
            data: {
                idx: idx,
