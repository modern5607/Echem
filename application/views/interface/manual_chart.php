  ...
  var chartDrowFun = {
    ...
    chartDrow: function() {
      ...
      function drawDashboard() {
        ...
        data.addColumn('number', 'EC(Sensor)');
        data.addColumn('number', 'EC(Manual)');
        ...
        foreach ($info as $row) { ?>
          ...
          var sensor = <?= ($row->SENSOR); ?>;
          var manual = <?= ($row->MANUAL == "")?0:$row->MANUAL; ?>;

          dataRow = [new Date(year, month, day, hour, min, sec), sensor, manual];
          data.addRow(dataRow);
