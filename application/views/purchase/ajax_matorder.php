	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tbody>
			<tr class="insertHead">
				...
				<td><input type="text" name="ADATE" class="calendar" size="15" autocomplete="off" value="<?= date("Y-m-d") ?>" style="border: 1px solid #ddd; padding: 5px 7px; width:100%; background: white;"></td>
				...
				<td><input type="text" name="DDATE" class="calendar" size="15" autocomplete="off" value="<?= date("Y-m-d") ?>" style="border: 1px solid #ddd; padding: 5px 7px; width:100%; background: white;"></td>
