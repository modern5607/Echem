            ...
            <div id="loading" style="margin: 170px 0px;"><img src='<?php echo base_url('_static/img/loader.gif'); ?>' width="100"></div>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="RAW_INPUT" class="form_input input_100" value="<?= isset($info->RAW_INPUT) ? $info->RAW_INPUT : '' ?>"></td>
                        <th class="w120 res">탄산나트륨(Kg)</th>
                        <td><input type="text" name="NA2CO3_INPUT" class="form_input input_100" value="<?= isset($info->NA2CO3_INPUT) ? $info->NA2CO3_INPUT : '' ?>"></td>
                    </tr>
                    <tr>
                        <th class="w120 res">LiCl</th>
                        <td><input type="text" name="LICL_INPUT" class="form_input input_100" value="<?= isset($info->LICL_INPUT) ? $info->LICL_INPUT : '' ?>"></td>
                        <th class="w120 res">염화나트륨</th>
                        <td><input type="text" name="NACL_INPUT" class="form_input input_100" value="<?= isset($info->NACL_INPUT) ? $info->NACL_INPUT : '' ?>"></td>
                    </tr>
                    <tr>
...
<script>
    ...
    $(".delBtn").click(function() {
        ...
        $.ajax({
            url: "<?= base_url('PROD/del_matinput') ?>",
            type: "POST",
            dataType: "HTML",
            data: formData,
            cache: false,
